        ...
        var r = {
            ...
            d = function () {
                ...
                !0 === KTUtil.hasClass(n.element, n.options.baseClass + '-on') && 'on' === String(i.getAttribute('data-kt-drawer-' + n.name + '-')) ? n.shown = !0 : n.shown = !1,
                    !0 === f('activate') ? (KTUtil.addClass(n.element, n.options.baseClass), KTUtil.addClass(n.element, n.options.baseClass + '-' + t), KTUtil.css(n.element, 'width', e, !0), n.lastWidth = e) : (KTUtil.css(n.element, 'width', ''), KTUtil.removeClass(n.element, n.options.baseClass), KTUtil.removeClass(n.element, n.options.baseClass + '-' + t), s())
            },
            c = function () {
                ...
                if (!0 === KTUtil.data(t).has(n)) {
                    ...
                    if (e[n] && e[n][o]) {
                        ...
                        if (a.name === n) {
                            ...
                            if (0 == a.fired) return e[n][o].fired = !0,
...
var KTFeedback = function (e) {
    ...
    r(),
        t.show = function () {
            return function () {
                if (!1 !== KTEventHandler.trigger(t.element, 'kt.feedback.show', t)) return 'popup' === t.options.type && a(),
        ...
        t.hide = function () {
            return function () {
                if (!1 !== KTEventHandler.trigger(t.element, 'kt.feedback.hide', t)) return 'popup' === t.options.type && s(),
                    t.shown = !1,
...
var KTImageInput = function (e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            l = function (e) {
                e.preventDefault(),
                !1 !== KTEventHandler.trigger(n.element, 'kt.imageinput.cancel', n) && (KTUtil.removeClass(n.element, 'image-input-changed'), KTUtil.removeClass(n.element, 'image-input-empty'), KTUtil.css(n.wrapperElement, 'background-image', n.src), n.inputElement.value = '', null !== n.hiddenElement && (n.hiddenElement.value = '0'), KTEventHandler.trigger(n.element, 'kt.imageinput.canceled', n))
            },
            s = function (e) {
                e.preventDefault(),
                !1 !== KTEventHandler.trigger(n.element, 'kt.imageinput.remove', n) && (KTUtil.removeClass(n.element, 'image-input-changed'), KTUtil.addClass(n.element, 'image-input-empty'), KTUtil.css(n.wrapperElement, 'background-image', 'none'), n.inputElement.value = '', null !== n.hiddenElement && (n.hiddenElement.value = '1'), KTEventHandler.trigger(n.element, 'kt.imageinput.removed', n))
            };
...
var KTMenu = function (e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            a = function (e) {
                e || (e = n.triggerElement),
                !0 !== m(e) && ('dropdown' === v(e) ? E(e) : 'accordion' === v(e) && S(e), KTUtil.data(e).set('type', v(e)))
            },
            l = function (e) {
                e || (e = n.triggerElement),
            ...
            I = function (e) {
                ...
                if (i && i.length > 0) for (var r = 0, o = i.length; r < o; r++) t = i[r],
                'accordion' === v(t) && t !== e && !1 === e.contains(t) && !1 === t.contains(e) && A(t)
            },
            x = function (e, t) {
                var n,
                    i = null;
                return e && e.hasAttribute('data-kt-menu-' + t) && (n = e.getAttribute('data-kt-menu-' + t), null !== (i = KTUtil.getResponsiveValue(n)) && 'true' === String(i) ? i = !0 : null !== i && 'false' === String(i) && (i = !1)),
                    i
            };
...
var KTPasswordMeter = function (e, t) {
    ...
    if (e) {
        var i = {
            ...
            f = function () {
                var e = [
                    ].slice.call(n.highlightElement.querySelectorAll('div')),
                    t = e.length,
                    i = 0,
                    r = m(),
                    o = g();
    ...
    if (e) {
        var i = {
            ...
            o = function () {
                ...
                n.menuObject && (n.toggleElement && (n.toggleElement.addEventListener('click', f), n.menuObject.on('kt.menu.dropdown.show', (function (e) {
            ...
            r = function () {
                ...
                n.options.startIndex > 1 && o(n.options.startIndex),
                    ...
                    KTUtil.on(n.element, '[data-kt-stepper-action="step"]', 'click', (function (e) {
                        if (e.preventDefault(), n.steps && n.steps.length > 0) for (var t = 0, i = n.steps.length; t < i; t++) if (n.steps[t] === this) return n.clickedStepIndex = t + 1,
...
var KTUtil = function () {
    ...
    return {
        ...
        sleep: function (e) {
            for (var t = (new Date).getTime(), n = 0; n < 10000000 && !((new Date).getTime() - t > e); n++);
        },
        ...
        parents: function (e, t) {
            for (var n = [
            ]; e && e !== document; e = e.parentNode) t ? e.matches(t) && n.push(e) : n.push(e);
            return n
        },
        children: function (e, t, n) {
            if (!e || !e.childNodes) return null;
            for (var i = [
            ], r = 0, o = e.childNodes.length; r < o; ++r) 1 == e.childNodes[r].nodeType && KTUtil.matches(e.childNodes[r], t, n) && i.push(e.childNodes[r]);
            return i
        },
        ...
        data: function (e) {
            return {
                set: function (t, n) {
                    e && (void 0 === e.customDataTag && (window.KTUtilElementDataStoreID++, e.customDataTag = window.KTUtilElementDataStoreID), void 0 === window.KTUtilElementDataStore[e.customDataTag] && (window.KTUtilElementDataStore[e.customDataTag] = {
        ...
        css: function (e, t, n, i) {
            if (e) if (void 0 !== n) !0 === i ? e.style.setProperty(t, n, 'important') : e.style[t] = n;
            else {
        ...
        hash: function (e) {
            ...
            for (t = 0; t < e.length; t++) n = (n << 5) - n + e.charCodeAt(t),
                n |= 0;
            return n
        },
        ...
        animateDelay: function (e, t) {
            for (var n = [
                ...
                'o-',
                ''
            ], i = 0; i < n.length; i++) KTUtil.css(e, n[i] + 'animation-delay', t)
        },
        animateDuration: function (e, t) {
            for (var n = [
                ...
                'o-',
                ''
            ], i = 0; i < n.length; i++) KTUtil.css(e, n[i] + 'animation-duration', t)
        },
        ...
        f = function (e) {
            setTimeout((function () {
                ...
                t.classList.add('d-none'),
                    3 === i ? (n.classList.add('d-none'), r.classList.remove('d-none')) : (n.classList.remove('d-none'), r.classList.add('d-none')),
                    e.complete()
            }), 1500)
        },
        p = function (e) {
