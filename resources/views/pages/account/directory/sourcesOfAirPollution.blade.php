...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item text-gray-500">ИЗА</li>
@endsection
<x-base-layout>
        ...
        <div class="card-header border-0 pt-6" bis_skin_checked="1">
            ...
            <div class="card-toolbar" bis_skin_checked="1">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base" bis_skin_checked="1">
                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_add_source">
                        Добавить ИЗА</button>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px" bis_skin_checked="1">
                        <div class="modal-content" bis_skin_checked="1">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7" bis_skin_checked="1">
                                <form id="kt_modal_add_source_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('directory.getSOAP') }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_sources">
                        ...
                        @foreach ($sources as $source)
                            <tr class="even">
                                ...
                                <td class="float-end">
                                    <?php if(isset($source->user_id) && $source->user_id != 0) { ?>
                                        <button class="btn btn-primary btn-sm editSource"
                                        ...
                                        <a href="/account/directory/deleteSOAP/{{$source->source_id}}" class="btn btn-danger btn-sm deleteSourceContent" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_source">
