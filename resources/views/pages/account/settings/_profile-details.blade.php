@section('breadcrumbs')
    ...
    <li class="breadcrumb-item text-gray-500">Редактирование</li>
@endsection
<!--begin::Basic info-->
<div class="card {{ $class }}">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{ __('Детали профиля') }}</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('Фото') }}</label>
                    <!--end::Label-->
...
{{--                </div>--}}
                ...
                <div class="row mb-6">
                    ...
                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                        <span class="required">{{ __('Телефон') }}</span>

                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="{{ __('Номер телефона должен быть активным') }}"></i>
                    </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="tel" name="phone" class="form-control form-control-lg form-control-solid" placeholder="Телефон" value="{{ old('phone', isset($info->phone) ? $info->phone : '') }}"/>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
