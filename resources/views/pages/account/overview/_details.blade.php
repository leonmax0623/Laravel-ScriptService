@section('breadcrumbs')
    ...
    <li class="breadcrumb-item text-gray-500">Мой профиль</li>
@endsection
<!--begin::details View-->
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-header cursor-pointer">
        ...
        <!--begin::Action-->
        <a href="{{ theme()->getPageUrl('account/settings') }}" class="btn btn-primary align-self-center">{{ __('Редактировать профиль') }}</a>
        <!--end::Action-->
    </div>
    <!--begin::Card header-->
