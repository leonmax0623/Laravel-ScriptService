...
@section('content')
    ...
    <div id="kt_content_container" class="container-xxl" bis_skin_checked="1">
        ...
        <div class="card mb-6" bis_skin_checked="1">
            <div class="card-body pt-9 pb-0" bis_skin_checked="1">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 navItem active userBalance" href="#">Баланс</a>
                    </li>
                </ul>
                <!--begin::Navs-->
            </div>
        ...
        <!--end::Navbar-->
        <!--begin::Toolbar-->
        <div id="balance"  class="card mb-6 userBlock">
            <div class="card" bis_skin_checked="1">
                <div class="card-header border-0 pt-6" bis_skin_checked="1">
                        <div class="card-title" bis_skin_checked="1"></div>
                    <div class="card-toolbar" bis_skin_checked="1">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base" bis_skin_checked="1">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_organization">Пополнить</button>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px" bis_skin_checked="1">
                                <div class="modal-content" bis_skin_checked="1">
                                    <div class="modal-header" id="kt_modal_add_organization_header" bis_skin_checked="1">
                                        <h2 class="fw-bolder">Пополнение счета</h2>
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7" bis_skin_checked="1">
                                        <form id="kt_modal_add_organization_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('admin.topUpUserAccount') }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_organization_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_organization_header" data-kt-scroll-wrappers="#kt_modal_add_organization_scroll" data-kt-scroll-offset="300px" bis_skin_checked="1" style="max-height: 520px;">
                                                ...
                                                <div class="fv-row mb-7 fv-plugins-icon-container" bis_skin_checked="1">
                                                    <label class="fw-bold fs-6 mb-2">Тип</label>
                                                    <select  name="type_id"  required data-placeholder="Выберите тип" class="form-select form-select-solid form-select-lg fw-bold" >
                                                        <option value="">Выберите тип пополнения</option>
                                                ...
                                                <div class="fv-row mb-7 fv-plugins-icon-container" bis_skin_checked="1">
                                                    <label class="fw-bold fs-6 mb-2">Сумма</label>
                                                    <input type="number" step="0.1" name="sum" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Сумма, руб." value="">
                                                    <div class="fv-plugins-message-container invalid-feedback" bis_skin_checked="1"></div>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-end" bis_skin_checked="1">
                                                <button type="submit" class="btn btn-primary" data-kt-organization-modal-action="submit">
                                                    <span class="indicator-label">Пополнить</span>
                                                </button>
                                            </div>
                ...
                <div class="card-body pt-0" bis_skin_checked="1">
                    <div id="kt_referred_users_tab_content" class="tab-content">
                        <div id="kt_referrals_3" class="card-body p-0 tab-pane fade active show" role="tabpanel">
...
{{--                                    <th tabindex="0" aria-controls="kt_table_organizations" rowspan="1" colspan="1">Дата</th>--}}
{{--                                    <th tabindex="0" aria-controls="kt_table_organizations" rowspan="1" colspan="1" >Детали</th>--}}

{{--                                    --}}{{--                            TODO добавить инфо о участии в проектах, на данный момент проектов нет --}}

{{--                                    <th tabindex="0" aria-controls="kt_table_organizations" rowspan="1" colspan="1" >Сумма</th>--}}
{{--                                    <th rowspan="1" colspan="1" aria-label="Actions" >Баланс</th>--}}
{{--                                </tr>--}}
{{--                                </thead>--}}
